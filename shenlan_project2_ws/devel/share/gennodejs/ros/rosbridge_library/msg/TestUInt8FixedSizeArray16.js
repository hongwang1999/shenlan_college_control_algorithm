...
class TestUInt8FixedSizeArray16 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.uint8(obj.data, buffer, bufferOffset, 16);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TestUInt8FixedSizeArray16(null);
    // Deserialize message field [data]
    data.data = _arrayDeserializer.uint8(buffer, bufferOffset, 16)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TestUInt8FixedSizeArray16(null);
...
module.exports = TestUInt8FixedSizeArray16;
