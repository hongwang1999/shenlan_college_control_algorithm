...
class TestMultipleRequestFieldsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TestMultipleRequestFieldsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TestMultipleRequestFieldsRequest
    let len;
    let data = new TestMultipleRequestFieldsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TestMultipleRequestFieldsRequest(null);
...
class TestMultipleRequestFieldsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
    }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TestMultipleRequestFieldsResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TestMultipleRequestFieldsResponse
    let len;
    let data = new TestMultipleRequestFieldsResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TestMultipleRequestFieldsResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: TestMultipleRequestFieldsRequest,
  Response: TestMultipleRequestFieldsResponse,
  md5sum() { return '6cce9fb727dd0f31d504d7d198a1f4ef'; },
  datatype() { return 'rosbridge_library/TestMultipleRequestFields'; }
};
