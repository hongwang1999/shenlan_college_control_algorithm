...
class MessageDetailsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MessageDetailsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MessageDetailsRequest
    let len;
    let data = new MessageDetailsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MessageDetailsRequest(null);
...
class MessageDetailsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MessageDetailsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MessageDetailsResponse
    let len;
    let data = new MessageDetailsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MessageDetailsResponse(null);
...
module.exports = {
  ...
  datatype() { return 'rosapi/MessageDetails'; }
};
