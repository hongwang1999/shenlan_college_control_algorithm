...
echo_and_run cd "/home/hongwang/shenlan_project2_ws/src/rosbridge_suite/rosbridge_library"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hongwang/shenlan_project2_ws/src/rosbridge_suite/rosbridge_library/setup.py" \
     \
    build --build-base "/home/hongwang/shenlan_project2_ws/build/rosbridge_suite/rosbridge_library" \
    install \
    --root="${DESTDIR-/}" \
